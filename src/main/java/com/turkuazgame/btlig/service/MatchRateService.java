...
import com.turkuazgame.btlig.service.rateresult.ActionServiceFactory;
import com.turkuazgame.btlig.service.rateresult.IActionService;
...
//        mergeMatchRate(matchRate.getMatchRateId(), fields);
    ...
    public boolean calculateRateRealization(MatchRate matchRate) {
        ...
        IActionService actionService = actionServiceFactory.createActionService(matchRate);
        return actionService.calculate();
    }
